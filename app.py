...
AZURE_OPENAI_RESOURCE = os.environ.get("AZURE_OPENAI_RESOURCE", "edig-openai")
AZURE_OPENAI_MODEL = os.environ.get("AZURE_OPENAI_MODEL","gpt-35-turbo-west-europe")
AZURE_OPENAI_KEY = os.environ.get("AZURE_OPENAI_KEY", "acf522cfd4d043e2b89ca8c31aac3f50")
...
def prepare_body_headers_with_data(request):
    ...
    print("Using OpenAI API URL:", chatgpt_url)  # Add this line
...
def conversation_without_data(request):
    ...
    for message in request_messages:
        ...
        print("Using OpenAI API URL:", openai.api_base + "openai/deployments/" + AZURE_OPENAI_MODEL)  # Add this line
...
def generate_chapter():
    ...
    chapter = openai.Completion.create(
        engine="gpt-3.5-turbo", 
        prompt=full_prompt, 
        max_tokens=4096
    )
    
    return jsonify(chapter.choices[0].text.strip()), 200
